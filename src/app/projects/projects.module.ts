...
@NgModule({
  ...
  declarations: [routedComponents, ProjectSocialComponent, ProjectAskOrganizerButtonComponent, OpportunityCommitmentsComponent,
    AddToCalendarComponent, OpportunityComponent, OpportunityDetailsComponent, OpportunityTeamsComponent, ProjectJoinComponent],
  providers: [OpportunityService, AddToCalendarService, LocationPipe]
})
